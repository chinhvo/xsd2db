...
namespace Xsd2Db
{
    ...
    public class Application
    {
        ...
        public Application(string[] args)
        {
            ...
            //xsd2db.exe - f - l DESKTOP-UMPTCAI - n hrm - s E:\Project\hrm\04 - Snapshot\Lacviet\db\_TEST.xsd - t       
        }
        ...
        public void Initialize()
        {
            ...
            if (!this.ShowHelp)
            {
                ...
                this.Schema.ReadXml(this.SchemaFile);
        ...
        [Parameter("location", "l",
            "The type of database to connect to (servername)")]
        ...
        private static void Main(string[] args)
        {
            ...
            foreach (string file in Directory.EnumerateFiles("E:\\Project\\xsd", "*.xsd"))
            {
                Application application = new Application(args);
                var schemaFile = file;
                application.commandline.Parameters.Get("force").Value = false;
                application.commandline.Parameters.Get("location").Value = "DESKTOP-UMPTCAI";
                application.commandline.Parameters.Get("name").Value = "hrm";
                application.commandline.Parameters.Get("schema").Value = schemaFile;
                application.commandline.Parameters.Get("type").Value = DatabaseType.Sql;
                TableName = Path.GetFileNameWithoutExtension(schemaFile);
                GenerateTable(application);
            }
        }


        private static void GenerateTable(Application application)
        {
            //xsd2db.exe - f - l DESKTOP - UMPTCAI - n hrm - s E:\Project\hrm\04 - Snapshot\Lacviet\db\_TEST.xsd - t        
            try
            {
                ...
                else
                {
                    ...
                    application.Schema.Tables[0].TableName = TableName;
                    ...
                    else
                    {
                        ...
                        application.Creator.SaveToDB(application.Schema.DataSetName, application.Schema);
                    }
